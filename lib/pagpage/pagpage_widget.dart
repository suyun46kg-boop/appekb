...
class PagpageWidget extends StatefulWidget {
  ...
  }) : this.idproductpage = idproductpage ?? '1';
        ...
        body: SafeArea(
          ...
          child: FutureBuilder<List<ListingsRow>>(
            future: ListingsTable().querySingleRow(
              queryFn: (q) => q.eqOrNull(
                ...
                valueOrDefault<String>(
                  widget!.idproductpage,
                  '0c27d65c-eeb3-4104-a599-1ba0b57bf34e',
                ),
              ),
            ),
            builder: (context, snapshot) {
              ...
              final columnListingsRow = columnListingsRowList.isNotEmpty
                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      valueOrDefault<String>(
                                        columnListingsRow?.price?.toString(),
                                        '0,00',
                                      ),
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          valueOrDefault<String>(
                                            columnListingsRow?.categoryName,
                                            'Нет',
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                            ...
                            children: [
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  await launchUrl(Uri(
                                    scheme: 'tel',
                                    path: columnListingsRow!.phonnumber!,
                                  ));
                                },
