...
class PolitpageWidget extends StatefulWidget {
  const PolitpageWidget({super.key});

  static String routeName = 'politpage';
  static String routePath = '/politpage';

  @override
  State<PolitpageWidget> createState() => _PolitpageWidgetState();
}

class _PolitpageWidgetState extends State<PolitpageWidget> {
  late PolitpageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PolitpageModel());
  }
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              Text(
                                FFLocalizations.of(context).getText(
                                  '0adnrtq1' /* Условия использования */,
                                ),
                              ...
                              Text(
                                FFLocalizations.of(context).getText(
                                  'daf8557q' /* Используя наш сервис, вы согла... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                              ...
                              Text(
                                FFLocalizations.of(context).getText(
                                  'o8n3z1wt' /* Пользователи обязуются не нару... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                              ...
                              Text(
                                FFLocalizations.of(context).getText(
                                  'gz8m61r5' /* Политика конфиденциальности */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .titleMedium
                                    .override(
                              ...
                              Text(
                                FFLocalizations.of(context).getText(
                                  '1rfa4veg' /* Мы уважаем вашу конфиденциальн... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                              ...
                              Text(
                                FFLocalizations.of(context).getText(
                                  'p55qtrla' /* Мы можем собирать следующие да... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                              ...
                              Text(
                                FFLocalizations.of(context).getText(
                                  'ykqa7gkh' /* Мы не передаём ваши данные тре... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        FFLocalizations.of(context).getText(
                          '3x5a0tt5' /* Продолжая, вы принимаете услов... */,
                        ),
