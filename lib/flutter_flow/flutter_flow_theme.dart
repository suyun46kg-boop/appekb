...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color accent2 = const Color(0xFFE7F3FF);
  late Color accent3 = const Color(0xFFD1E7FF);
  late Color accent4 = const Color(0xFFB0D4FF);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF001F6D);
  late Color secondary = const Color(0xFFE0E0E0);
  late Color tertiary = const Color(0xFF6B9BD6);
  late Color alternate = const Color(0xFF003D7A);
  ...
  late Color accent2 = const Color(0xFFB3D7FF);
  late Color accent3 = const Color(0xFFA6C8FF);
  late Color accent4 = const Color(0xFF7FB3FF);
  late Color success = const Color(0xFF218838);
  late Color warning = const Color(0xFFD39E00);
  late Color error = const Color(0xFFC82333);
  late Color info = const Color(0xFF117A8B);
}
