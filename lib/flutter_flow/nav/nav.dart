...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
            name: CreateListingPageCopyWidget.routeName,
        ...
        FFRoute(
            ...
            path: TovarypocategoyWidget.routePath,
            builder: (context, params) => NavBarPage(
                  initialPage: '',
                  page: TovarypocategoyWidget(
                    paramcatid: params.getParam(
                      'paramcatid',
                      ParamType.int,
                    ),
                  ),
        ...
        FFRoute(
            name: PagpageWidget.routeName,
            path: PagpageWidget.routePath,
            builder: (context, params) => NavBarPage(
                  initialPage: '',
                  page: PagpageWidget(
                    idproductpage: params.getParam(
                      'idproductpage',
                      ParamType.String,
                    ),
                  ),
